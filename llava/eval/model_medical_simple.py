...
def eval_model(args):
    ...
    with open(os.path.expanduser(args.question_file), 'rb') as handle:
        questions = pickle.load(handle)
    questions = get_chunk(questions, args.num_chunks, args.chunk_idx)
    image_transformation = transforms.Compose([CopyChannel()])
    ...
    for line in tqdm(questions[:1000]):
        ...
        results = load_single_image(line, args.image_folder, args.seg_folder, image_transformation) 
        image = results['image'] 
